...
entrada_celsius = tkinter.Label(cuadro1,
                                text='_ _ _ _ _',
                                bg='lightblue',
                                font=('consolas', 18, 'bold'))
entrada_celsius.pack(side=tkinter.LEFT, padx=20, pady=20)
cuadro1.pack()
...
entrada_fahrenheit = tkinter.Label(cuadro2,
                                text='_ _ _ _ _',
                                bg='lightblue',
                                font=('consolas', 18, 'bold'))
entrada_fahrenheit.pack(side=tkinter.LEFT, padx=20, pady=20)
cuadro2.pack()
