...
entrada_grados = tkinter.Entry(cuadro1, bg='white', fg='black', font=('consolas', 18, 'bold'), relief=tkinter.SUNKEN, width=10, justify=tkinter.RIGHT, state='normal')       # Justificamos el texto a la derecha
...
boton_convertir = tkinter.Button(cuadro3, text='Convertir', bg='orange', font=('consolas', 18, 'bold'), width=10, command=convertir, state='normal')
